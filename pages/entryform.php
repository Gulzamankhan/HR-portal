                    ...
                    <div class="row">
                            ...
                            <div class="col-md-2 text-right">
                                    <div class="form-group">
                                            <label for="projectCode">Project Codes</label>
                                    </div>
                            </div>
                            <div class="col-md-2">
                                    <div class="form-group">
                                        <input type="text" class="form-control" name="projectCode1" maxlength="45">
                                    </div>
                            </div>
                            <div class="col-md-2">
                                    <div class="form-group">
                                            <input type="text" class="form-control" name="projectCode2" maxlength="45">
                                    </div>
                            </div>
                            <div class="col-md-2">
                                    <div class="form-group">
                                            <input type="text" class="form-control" name="projectCode3" maxlength="45">
                                    </div>
                            </div>
                            <div class="col-md-2">
                                    <div class="form-group">
                                            <input type="text" class="form-control" name="projectCode4" maxlength="45">
                                    </div>
                            </div>
                            <div class="col-md-3">
                            </div>
    ...
    <?php 
                ...
                <div class="row text-center" style="margin-top: 15px;">
                    <div class="col-md-6 col-md-offset-3">
                        <div class="form-group">
                            <label for="projectCode">Notes</label>
