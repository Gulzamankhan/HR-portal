			...
			<div class="row pageCont">
				<div class="col-md-12 pb-20">
					...
					?>
							...
							<li><a href="index.php?page=activeUsers"><i class="fa fa-group"></i>Active Users</a></li>
			<li class="active"><a href="#home" data-toggle="tab"><i class="fa fa-ban"></i>Inactive Users</a></li>
										...
										<?php while ($row = mysqli_fetch_assoc($res)) { ?>
											<tr>
												<td>
													...
													<td class="text-center"><?php echo $suser.$admUser; ?></td>
